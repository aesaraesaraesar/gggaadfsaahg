...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب روبن  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/F_O_1")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "غير متوفر حالياً ")],
                [Button.url("كروب المساعدة ❓", "https://t.me/uui7rb")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @k_jj_j", alert=True)
...
async def settings(event):  #    قـسـم  الزغرفـة جمـثـون
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @RobinUserBot", alert=True)
...
async def settings(event): #    قـسـم  الزغرفـة لأسـماء البـنات
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @F_O_1", alert=True)
